...
namespace MMUniGraduation.Migrations
{
    ...
    [Migration("20220923105806_InitialCreate")]
            ...
            modelBuilder.Entity("MMUniGraduation.Models.Course", b =>
                {
                    ...
                    b.Property<string>("SkipCoursEndDate")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MMUniGraduation.Models.RestrictAccess", b =>
                {
                    ...
                    b.HasOne("MMUniGraduation.Models.SkippingAssignment", "SkippingAssignment")
                        .WithMany()
