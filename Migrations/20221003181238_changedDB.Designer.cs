...
namespace MMUniGraduation.Migrations
{
    ...
    [Migration("20221003181238_changedDB")]
            ...
            modelBuilder.Entity("MMUniGraduation.Models.RestrictAccess", b =>
                {
                    ...
                    b.Property<int?>("CourseStudyProgramId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("CourseStudyProgramId");
            ...
            modelBuilder.Entity("MMUniGraduation.Models.Student", b =>
                {
                    ...
                    b.Property<int?>("CurrentCourseStudyProgramId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CurrentCourseStudyProgramId");
            ...
            modelBuilder.Entity("MMUniGraduation.Models.RestrictAccess", b =>
                {
                    b.HasOne("MMUniGraduation.Models.Course", "Course")
                        .WithMany()
                        .HasForeignKey("CourseStudyProgramId");
            ...
            modelBuilder.Entity("MMUniGraduation.Models.Student", b =>
                {
                    b.HasOne("MMUniGraduation.Models.Course", "CurrentCourse")
                        .WithMany()
                        .HasForeignKey("CurrentCourseStudyProgramId");
